...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.ehsannarmani/compose-charts?color=4caf50&label=Latest%20Release&v=3)](https://central.sonatype.com/artifact/io.github.ehsannarmani/compose-charts/overview)
```gradle
dependencies {
